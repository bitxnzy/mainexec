        ...
        if Settings.Chest then
            ...
            if chest then
                ...
                if not game.Players.LocalPlayer.QuestCD.Value then
                    ...
                    local quest = plr.PlayerGui:FindFirstChild("Quest") and plr.PlayerGui.Quest.Main
    
                    if quest and quest.Visible then
                        local Colar = game.workspace.Effects:FindFirstChild("Part")
                        if Colar then
                            local itemframe = GetCFrame(Colar)
                            local tween = tweenModel(plr.Character, itemframe)
                            if tween then
                                tween.Completed:Wait()
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, Enum.KeyCode.E, false, game)
                                local npccframe = GetCFrame(npcquest)
                                local tween = tweenModel(plr.Character, npccframe)
                                if tween then
                                    tween.Completed:Wait()
                                    game:GetService("VirtualInputManager"):SendKeyEvent(true, Enum.KeyCode.T, false, game)
                                else
                                    print("Falha ao criar tween para NPC")
                                end
                            else
                                print("Falha ao criar tween para item")
                            end
                        else
                        ...
                        if npcquest then
                            ...
                            if tween then
                                ...
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, Enum.KeyCode.T, false, game)
                                pcall(function()
                                    local npcChat = plr.PlayerGui:FindFirstChild("NPCCHAT")
                                    while npcChat do
                                        ...
                                        npcChat = plr.PlayerGui:FindFirstChild("NPCCHAT") -- Atualiza o npcChat para verificar se ainda existe
